"""Configuration for GP2 v3 robot."""
...
@configclass
class GP2v3ArticulationCfg(ArticulationCfg):
    """Configuration for GP2 v3 articulations."""
...
@configclass
class GP2v3UsdFileCfg(sim_utils.UsdFileCfg):
...
GP2_V3_CFG = GP2v3ArticulationCfg(
    spawn=GP2v3UsdFileCfg(
        usd_path=f"{LEGGED_LAB_ROOT_DIR}/data/Robots/gp2/gp2/gp2_v3_simple_collision.usd",
    ),
